  ...
  return (
    ...
    <div id='popup-wrap' className=" shadow-md rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
      <h2 id='news-head' className="text-white text-lg mb-1 font-medium title-font">Subscribe To Our Newsletter</h2>
          <button id='close' onClick={closeModal} className="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">X</button>
      ...
      <div className="relative mb-4">
        <label for="email" className="leading-7 text-sm text-black-400">Email</label>
      ...
      <button id='close' className="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Subscribe</button>
    </div>
  </div>
  )
}
