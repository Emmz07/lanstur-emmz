...
const Step = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap">
    ...
    <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        <div className="flex-shrink-0 w-24 h-24 bg-blue-100 text-indigo-500 rounded-full inline-flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="48px" height="48px"><path fill="#64717c" d="M38.526,12.292l-3.052-2.584L25.073,22H11v4h14.072l10.402,12.292l3.052-2.584L28.62,24	L38.526,12.292z"/><linearGradient id="vxgPzRsDITHnIzt27yRPEa" x1="4.491" x2="15.13" y1="18.976" y2="28.678" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#33bef0"/><stop offset="1" stop-color="#0a85d9"/></linearGradient><circle cx="10" cy="24" r="6" fill="url(#vxgPzRsDITHnIzt27yRPEa)"/><linearGradient id="vxgPzRsDITHnIzt27yRPEb" x1="31.983" x2="40.579" y1="6.182" y2="14.437" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#33bef0"/><stop offset="1" stop-color="#0a85d9"/></linearGradient><circle cx="37" cy="11" r="6" fill="url(#vxgPzRsDITHnIzt27yRPEb)"/><linearGradient id="vxgPzRsDITHnIzt27yRPEc" x1="32.454" x2="42.411" y1="32.26" y2="42.642" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#33bef0"/><stop offset="1" stop-color="#0a85d9"/></linearGradient><circle cx="37" cy="37" r="6" fill="url(#vxgPzRsDITHnIzt27yRPEc)"/></svg>
        </div>
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
    ...
    <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        <div className="flex-shrink-0 w-24 h-24 bg-blue-100 text-indigo-500 rounded-full inline-flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="48px" height="48px"><linearGradient id="Z3eIuf5QY2EetuA~FfDd6a" x1="9.899" x2="38.183" y1="9.98" y2="38.264" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#33bef0"/><stop offset="1" stop-color="#0a85d9"/></linearGradient><path fill="url(#Z3eIuf5QY2EetuA~FfDd6a)" d="M44.041,24.122c0,11.045-8.955,20-20,20s-20-8.955-20-20s8.955-20,20-20	S44.041,13.077,44.041,24.122z"/><path d="M22,36h4c0.552,0,1-0.448,1-1V20c0-0.552-0.448-1-1-1h-4c-0.552,0-1,0.448-1,1v15	C21,35.552,21.448,36,22,36z" opacity=".05"/><path d="M22.227,35.5h3.547c0.401,0,0.727-0.325,0.727-0.727V20.227c0-0.401-0.325-0.727-0.727-0.727h-3.547	c-0.401,0-0.727,0.325-0.727,0.727v14.547C21.5,35.175,21.825,35.5,22.227,35.5z" opacity=".07"/><radialGradient id="Z3eIuf5QY2EetuA~FfDd6b" cx="24" cy="16" r="5.108" gradientTransform="matrix(.7808 0 0 .7066 5.26 4.096)" gradientUnits="userSpaceOnUse"><stop offset=".516"/><stop offset="1" stop-opacity="0"/></radialGradient><ellipse cx="24" cy="15.402" fill="url(#Z3eIuf5QY2EetuA~FfDd6b)" opacity=".15" rx="3.988" ry="3.609"/><path fill="#fff" d="M24,17.732c1.7,0,2.65-1.068,2.65-2.388C26.65,14.024,25.647,13,24,13s-2.65,1.024-2.65,2.344	C21.35,16.664,22.3,17.732,24,17.732z"/><rect width="4" height="15" x="22" y="20" fill="#fff"/></svg>
        </div>
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
